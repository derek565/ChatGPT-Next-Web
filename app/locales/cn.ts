...
const cn = {
  ...
  Error: {
    Unauthorized: isApp
      ...
      : "访问密码不正确或为空，请前往[登录](/#/auth)页输入正确的访问密码。如有任何疑问，您可以在 GitHub 上提交 issue 或发送邮件至 support@347108.xyz。虽然我可能无法立即回复，但会尽力处理您的问题。祝您体验愉快！温馨提示：请检查垃圾邮件或广告邮件文件夹，以防我们的回复被误分类。",
  },
  Auth: {
    Title: "需要密码",
